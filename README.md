...
3 - Siga as instruções de instalação da API utilizada pelo aplicativo UFLANews [clicando aqui](https://github.com/RaphaelRoriz/Trabalho-pratico-implementacao-e-modelagem-de-software/blob/master/UFLAnews-api/README.md).
